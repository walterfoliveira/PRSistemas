...
begin
  ...
  try
    ...
    qryTemp.SQL.Clear;
    qryTemp.SQL.Add
      ('Select Cli.*, EndCli.Id as EnderecoID, EndCli.Endereco, EndCli.Num, EndCli.Cidade, EndCli.Estado, EndCli.Cep from dbo.cliente Cli');
    qryTemp.SQL.Add
      ('Left Join dbo.Endereco EndCli on Cli.Id = EndCli.IdCliente');
    ...
    try
      ...
      on E: Exception do
      begin
        Erro := 'Erro ao Pesquisar no GetCliente[' + Id.ToString + ']:' + #13 +
          E.Message;
        Result := nil;
      end;
    end;
...
begin
  ...
  try
    ...
    qryTemp.SQL.Clear;
    qryTemp.SQL.Add
      ('Insert into dbo.cliente(nome, nomeMae, nomePai, cpf, rg) values (:Nome, :NomeMae, :NomePai, :Cpf, :Rg)');
    ...
    if (qryTemp.RowsAffected = 0) then
    begin
        Erro := 'Erro ao tentar Inserir Cliente';
        Result := false;
    end;
    ...
    qryTemp.SQL.Clear;
    qryTemp.SQL.Add
      ('Insert into dbo.endereco(idCliente, Endereco, num, cidade, estado, cep) values (:IdCliente, :Endereco, :Num, :Cidade, :Estado, :Cep)');
    ...
    try
      ...
      on E: Exception do
      begin
        Erro := 'Erro ao tentar Inserir Endereço do Cliente :' + #13 +
          E.Message;
        Result := false;
      end;
    end;
...
begin
  ...
  try
    ...
    qryTemp.SQL.Clear;
    qryTemp.SQL.Add
      ('Update dbo.endereco Set Endereco = :Endereco, num = :Num, cidade = :Cidade, estado = :Estado, cep = :Cep Where Id = :Id');
    ...
    try
      ...
      on E: Exception do
      begin
        Erro := 'Erro ao tentar Atualizar Endereço do Cliente :' + #13 +
          E.Message;
        Result := false;
      end;
    end;
